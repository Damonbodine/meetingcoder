...
This guide covers how to set up the development environment and build MeetingCoder from source across different platforms.
...
MeetingCoder requires a VAD (Voice Activity Detection) model to function
