# Contributing to MeetingCoder

Thank you for your interest in contributing to MeetingCoder! This guide will help you get started with contributing to this open source speech-to-text application.

## 📖 Philosophy

MeetingCoder aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ```bash
   git clone git@github.com:YOUR_USERNAME/MeetingCoder.git
   cd MeetingCoder
   ```

3. **Add upstream remote**:
   ```bash
   git remote add upstream git@github.com:Damonbodine/meetingcoder.git
   ```
...
MeetingCoder follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/Damonbodine/meetingcoder/issues](https://github.com/Damonbodine/meetingcoder/issues)
2. **Check discussions** at [github.com/Damonbodine/meetingcoder/discussions](https://github.com/Damonbodine/meetingcoder/discussions)
...
1. **Search existing discussions** at [github.com/Damonbodine/meetingcoder/discussions](https://github.com/Damonbodine/meetingcoder/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/Damonbodine/meetingcoder/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/Damonbodine/meetingcoder/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/Damonbodine/meetingcoder/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with MeetingCoder's philosophy
...
7. **Create a Pull Request**:
   - Go to the [MeetingCoder repository](https://github.com/Damonbodine/meetingcoder)
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/Damonbodine/meetingcoder/discussions)
- **Issues**: Report bugs or request features at [GitHub Issues](https://github.com/Damonbodine/meetingcoder/issues)

## 📜 License

By contributing to MeetingCoder, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to MeetingCoder!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
